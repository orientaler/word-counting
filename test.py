...
def run(src_path=None):
    ...
    if hasattr(wordfreq, "countWords"):
        ...
        test(
            wordfreq.countWords,
            (["clean", "water", "is", "drinkable", "water"], []),
            {"clean": 1, "water": 2, "is": 1, "drinkable": 1},
        )
        test(
            wordfreq.countWords,
            (["clean", "water", "is", "drinkable", "water"], ["is"]),
            {"clean": 1, "water": 2, "drinkable": 1},
        )
    else:
    ...
    if hasattr(wordfreq, "printTopMost"):
        ...
        test(
            printTopMost,
            ({"C": 3, "python": 5, "haskell": 2, "java": 1}, 3),
            "python                  5\nC                       3\nhaskell                 2\n",
        )
    else:
